...
public class Producer {
    ...
    public KafkaProducer<String, String> createProducer(){
        ...
        // High Throughput Producer (at the expense of a bit of latency and CPU usage)
            ...
            properties.setProperty(ProducerConfig.LINGER_MS_CONFIG, "5"); // ms waiting before sending a batch out
            properties.setProperty(ProducerConfig.BATCH_SIZE_CONFIG, Integer.toString(8*1024)); // 8 KB batch size
